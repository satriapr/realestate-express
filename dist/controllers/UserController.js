...
class UserController {
    ...
    getUsers(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield this.userService.findUsers(fullName);
    ...
    storeUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { fullName, role, email, password, mobilePhone } = req.body;
                yield this.userService.saveUser(fullName, role, email, password, mobilePhone);
                res.json((0, response_1.responseSuccess)(Constant_1.default.OK.CODE, Constant_1.default.OK.MESSAGE, {}));
                return;
            }
            catch (err) {
                throw new Error((0, lodash_1.get)(err, 'message', 'UserController.storeUser'));
            }
        });
    }
    deleteUser(req, res) {
